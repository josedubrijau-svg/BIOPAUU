...
(function () {
  ...
  function MESES() { return MESES_ALL[lang()] || MESES_ALL.es; }
  function DIASW() { return DIAS_ALL[lang()] || DIAS_ALL.es; }
  function markedTxt(n) { return tr(n === 1 ? 'cal.marked_1' : 'cal.marked_n', { n: n }); }
  ...
  function render() {
    ...
    var html = DIASW().map(function (d) { return '<div class="cal-dow">' + d + '</div>'; }).join('');
    ...
    if (res) res.textContent = markedTxt(marcados);
  }
