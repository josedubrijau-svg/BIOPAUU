...
window.BPI18n = (function () {
  ...
  var DICT = {
    ...
    'dl.intro':             { ca: 'Un repte breu cada dia. Ni obligatori ni interminable: una oportunitat diària per no perdre el ritme.', es: 'Un reto breve cada día. Ni obligatorio ni interminable: una oportunidad diaria para no perder el ritmo.' },
    'dl.tab_reto':          { ca: 'Repte del dia',      es: 'Reto del día' },
    'dl.tab_stats':         { ca: 'Estadístiques',      es: 'Estadísticas' },
    'dl.tab_config':        { ca: 'Configura el Daily', es: 'Configura tu Daily' },
    'nav.calendario':       { ca: 'Calendari',          es: 'Calendario' },
    'nav.novedades':        { ca: 'Novetats',           es: 'Novedades' },
    'tt.title':             { ca: 'Tests — BioPAU',     es: 'Tests — BioPAU' },
    'tt.h1':                { ca: 'Tests i simulacres', es: 'Tests y simulacros' },
    'tt.intro':             { ca: 'Posa a prova el que estudies. Completa el mini test de cada bloc per desbloquejar el test final tipus PAU.', es: 'Pon a prueba lo que estudias. Completa el mini test de cada bloque para desbloquear el test final tipo PAU.' },
    'tt.tab_tests':         { ca: 'Tests',              es: 'Tests' },
    'tt.tab_history':       { ca: 'Els meus resultats', es: 'Mis resultados' },
    'mod.tests_t':          { ca: 'Tests i simulacres', es: 'Tests y simulacros' },
    'mod.tests_p':          { ca: 'Mini tests per tema i tests finals tipus PAU, amb correcció i explicacions.', es: 'Mini tests por tema y tests finales tipo PAU, con corrección y explicaciones.' },
    'mod.tests_go':         { ca: 'Practicar',          es: 'Practicar' },
    'mod.tests_meta':       { ca: 'Comprova què domines', es: 'Comprueba lo que dominas' },
    ...
    'cal.intro3':           { ca: 'Planifica exàmens, simulacres, punts de control i sessions d’estudi. Fes clic en un dia per afegir o veure esdeveniments.', es: 'Planifica exámenes, simulacros, puntos de control y sesiones de estudio. Haz clic en un día para añadir o ver eventos.' },
